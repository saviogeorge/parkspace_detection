...
*/
std::vector<cv::Mat> Yolov5Model::pre_process(cv::Mat &input_image, cv::dnn::Net &net)
{
    // Convert to blob.
    cv::Mat blob;
...
*/
Image Yolov5Model::post_process(cv::Mat &input_image, std::vector<cv::Mat> &outputs)
{
    ...
    obj.img = input_image;
    obj.box_intersect_list = intersect_list(boxes, indices);
...
* @param class_ids
*/
void Yolov5Model::draw_bounding_boxes(cv::Mat &input_image, std::vector<cv::Rect> &box_list, std::vector<float> &confidence_list, std::vector<int> &box_indices, std::vector<int> &class_ids)
{
...
* @param box_indices
*/
std::vector<bool> Yolov5Model::intersect_list(std::vector<cv::Rect> &box_list, std::vector<int> &box_indices)
{
...
*/
void Yolov5Model::get_classification_list(std::vector<std::string> &class_list)
{
...
*/
void Yolov5Model::draw_label(cv::Mat& input_image, std::string label, int left, int top)
{
